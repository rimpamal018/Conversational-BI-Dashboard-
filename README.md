...
```bash
git clone https://github.com/rimpamal018/Conversational-BI-Dashboard.git
```
...
This project was developed by **Team PHOENIX**, a group of students from the **MCA 1st Year program under MAKAUT (Maulana Abul Kalam Azad University of Technology)**.
